...
var cartOpenedAt = 0;
    ...
    function updateCartUI(cart) {
      ...
      items.forEach(function(item){
        ...
        // 3-bottle (52515952001205) bought as Subscribe & Save does NOT ship free
        var freeship=(PM_FREE_SHIP.indexOf(vid)!==-1 && !(vid==='52515952001205' && subbed))?'<span class="cart-item__freeship"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="3" width="15" height="13"/><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg> Free Shipping</span>':'';
        html+='<div class="cart-item">'
          ...
          +'<div class="cart-item__info">'
            +'<div class="cart-item__head">'
              +'<div class="cart-item__main">'
                ...
                +'<div class="cart-item__left">'+variant+freeship+'</div>'
              +'</div>'
              +'<div class="cart-item__right">'
